    ...
    <v-app>
        <nav>
            <v-app-bar elevation="4" class="primary" app>
                ...
                <v-toolbar-title><span class="white--text "> ADMIN PANEL </span></v-toolbar-title>
                <v-spacer></v-spacer>
...
<!--                    <v-icon>exit_to_app</v-icon>-->
        ...
        <edit_users v-if="showHomeComponent"></edit_users>
    ...
    data() {
        return {
            ...
            links: [
                ...
                { icon:'dashboard', title:'View sessions' , routes:'/edit_sessions'},
                { icon:'dashboard', title:'Delete users' , routes:'/edit_users'},
                { icon:'dashboard', title:'Delete Sessions' , routes:'/allsessions'},
                { icon:'dashboard', title:'Add New Admin' , routes:'/adminRegister'},
